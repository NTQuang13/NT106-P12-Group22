...
//            StreamReader sr = new StreamReader(thisUserNetworkStream);
            try
            {
                while (!stopChatServer)
                {
...
//                    if (msg == "REQUEST_TO_SEND")
//                    {
//                        if (dict.TryGetValue(friendUsername, out friendTcpClient))
//                        {
//                            NetworkStream friendNetworkStream = friendTcpClient.GetStream();
//                            byte[] sendingBuffer = new byte[BufferSize];
//
//                            while (thisUserNetworkStream.DataAvailable)
//                            {
//                                friendNetworkStream.Write(sendingBuffer, 0, BufferSize);
//                            }
//                        }
//                    }
//                    else
